...
final class SourceSelectionViewModel {
    ...
    init(settingsService: SettingsService) {
        ...
        guard let url = Bundle.module.url(forResource: "sources", withExtension: "json", subdirectory: "Data"), let jsonData = try? Data(contentsOf: url) else {
            fail("Invalid bundle sources file")
        }
